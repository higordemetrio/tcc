        ...
        <div role="tabpanel">
            <div class="col-sm-2">
                <ul class="nav nav-pills brand-pills nav-stacked" role="tablist">
                    ...
                    <li role="presentation" class="brand-nav"><a href="#tab3" aria-controls="tab3" role="tab" data-toggle="tab">Editar Edição</a></li>
                    <li role="presentation" class="brand-nav"><a href="#tab4" aria-controls="tab4" role="tab" data-toggle="tab">Ir para uma Edição</a></li>
                    <li role="presentation" class="brand-nav"><a href="#tab5" aria-controls="tab5" role="tab" data-toggle="tab">Como funciona</a></li>
                </ul>
            </div>
            <div class="col-sm-10">
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab4">         
                        <?php include 'telas/inicio/irparaedicao.php'; ?> 
                        <div class='col-sm-12' id=espaco></div>
                    </div>
