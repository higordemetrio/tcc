...
function addCampoTime2() {
    iTime2++;
    var campo_num = '<div class="col-sm-10"> <div id = numero class="form-group col-sm-3"> <input type="text" class="form-control" id="time2_numero" name="time2_numero'+iTime2+'"> </div>';
