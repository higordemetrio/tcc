...
/*    var telMask = ['(99) 9999-99999', '(99) 99999-9999'];
    VMasker(document.getElementById("tel")).maskPattern(telMask[0]);
...
*/
    //Aplica Mascara para o CPF
    //VMasker(document.getElementById("profile_id_user")).maskPattern("999.999.999-99");

    //Aplica Mascara para o CEP
    //VMasker(document.getElementById("cep")).maskPattern("99999-999");

    //Aplica Mascara para a data
    VMasker(document.getElementById("datanasc")).maskPattern("99/99/99");
});
