...
$(document).ready(function(){
    $("#addCampoMatchReport").click(function(){
        i++;
        
        var campoTime1 = " <div class='col-sm-12' id=mrcampo"+i+"> <div class='col-sm-3' style='text-align: center;'> <input type='text' class='form-control' name='time1report"+i+"'> </div>";
        ...
        $("#mrcampos").append(campo);

    });

    $("#subCampoMatchReport").click(function(){
        $("#mrcampo"+i).remove();
         i--;
    });
});