...
<P align="center" class="col-sm-10 col-sm-offset-1"  >
    <a type="button" href="../partida/ondeencontrar/playerstatistics_ondeencontrar.php" target="_blank" class="btn btn-primary"> Onde encontrar? </a> 
    
</p>
<hr class="col-sm-12">
 <div class="col-sm-12"> 
        <div class="col-sm-12">
                <label for="tempo">Jogadores Cadastrados:</label>
        </div>
        <div class="col-sm-2">
            <select class="form-control" id="tempo" name="jg">
                <option></option>
                <option>12</option>
            </select>
        </div>
